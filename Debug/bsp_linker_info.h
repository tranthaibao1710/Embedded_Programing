...
#define BSP_PARTITION_RAM_CPU0_C_START (0x20080000)
#define BSP_PARTITION_RAM_CPU0_C_SIZE (0x0)
#define BSP_PARTITION_FLASH_CPU0_S_START (0x00000000)
#define BSP_PARTITION_FLASH_CPU0_S_SIZE (0x200000)
#define BSP_PARTITION_FLASH_CPU0_C_START (0x00200000)
#define BSP_PARTITION_FLASH_CPU0_C_SIZE (0x0)
#define BSP_PARTITION_DATA_FLASH_CPU0_S_START (0x08000000)
#define BSP_PARTITION_DATA_FLASH_CPU0_S_SIZE (0x2000)
#define BSP_PARTITION_QSPI_FLASH_CPU0_S_START (0x60000000)
#define BSP_PARTITION_QSPI_FLASH_CPU0_S_SIZE (0x4000000)
